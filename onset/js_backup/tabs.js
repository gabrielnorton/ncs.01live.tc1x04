...
(function($){
  ...
  $('<div class="tab-list"><ul class="tabs"></ul></div>').prependTo($('.block-blockgroup').children('.content'));

  $('.block-blockgroup').addClass('clearfix');
  $('.block-blockgroup').each(function(index0){
